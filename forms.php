...
include 'header.php';?>
		<div class="b-block">
			...
			<form class="b-form" action="send/question.php" method="POST" data-file-action="addFile.php">
				<h2>Заголовок</h2>
				<div class="b-form-content">
					<div class="b-input">
			...
			<form class="b-form b-accordeon-form" action="send/question.php" method="POST">
