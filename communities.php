			...
			<div class="b-content-inner">
				...
				<div class="b-materials" id="b-materials">
					...
					<div class="b-materials-list">
						...
						<a href="#" class="b-materials-item file-doc">Презентация_21.05.2019 Научный мониторинг ЕОТ_АндриановаМС</a>
						<a href="#" class="b-materials-item file-pdf">Презентация_21.05.2019 Управление интеллектуальной собственностью через создание IP-портфолио компании_ОрловаВВ</a>
						<a href="#" class="b-materials-item file-jpg">Презентация_21.05.2019 Факторы успеха и препятствия в реализации научно-технических проектов_КоваленкоДА</a>
					</div>
				</div>
			</div>
		</div>
